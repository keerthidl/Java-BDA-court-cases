 ...
 *
 */
public class LegalOpinionAllTransResponse {
	...
	/** list of advocates **/
	private List<LOpinionTransHistoryEntity> response = new ArrayList();
	 ...
	 * @return the response
	 */
	public List<LOpinionTransHistoryEntity> getResponse() {
		return response;
	}
	 ...
	 */
	public void setResponse(List<LOpinionTransHistoryEntity> response) {
